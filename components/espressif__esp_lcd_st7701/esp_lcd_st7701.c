                                   ...
                                   esp_lcd_panel_handle_t *ret_panel)
{
    ...
    case LCD_RGB_ELEMENT_ORDER_RGB:
        st7701->madctl_val = 0;
        ESP_LOGI(TAG, "LCD_RGB_ELEMENT_ORDER_RGB");
        break;
    case LCD_RGB_ELEMENT_ORDER_BGR:
        st7701->madctl_val |= LCD_CMD_BGR_BIT;
        ESP_LOGI(TAG, "LCD_RGB_ELEMENT_ORDER_BGR");
        break;
    default:
    ...
    if (st7701->flags.auto_del_panel_io) {
         ...
         */
        ESP_LOGI(TAG, "panel_st7701_send_init_cmds");
    ...
    ESP_LOGI(TAG, "new st7701 panel @%p", st7701);
